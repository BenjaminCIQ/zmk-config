...
This fork adapts urob's config for the Dasbob 36-key board and adds:

- 36-key Dasbob support for `nice_nano@2.0.0`, including left/right shields and settings reset.
